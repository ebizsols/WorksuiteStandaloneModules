...
<?php $component->withAttributes(['id' => 'save-product-form']); ?>
            ...
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.add'); ?> <?php echo app('translator')->get('property::app.propertyTypes'); ?></h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
...
<script>
    $(document).ready(function() {
        ...
        $('#save-product').click(function() {
            const url = "<?php echo e(route('property_types.store')); ?>";
...
<?php /**PATH D:\xampp\htdocs\standalone\Modules\Property\Providers/../Resources/views/settings/propertyTypes/ajax/create.blade.php ENDPATH**/ ?>