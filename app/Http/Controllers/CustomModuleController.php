...
class CustomModuleController extends AccountBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        $moduleName = str_replace("app", '', $moduleName);
    ...
    {
        $wrongMessage = 'The zip that you are trying to install is nhsfgsgfdsot compatible with ' . config('froiden_envato.envato_product_name') . ' version';
...
//dd($moduleName);
        ...
        return [
            'status' => false,
            'message' => 'The zip thatndhgdjfdhgdhgfd you are trying to install is not compatible with ' . config('froiden_envato.envato_product_name') . ' version'
        ];
    }
