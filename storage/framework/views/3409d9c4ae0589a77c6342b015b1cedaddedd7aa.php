...
<?php $component->withAttributes(['id' => 'save-product-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.edit'); ?> <?php echo app('translator')->get('property::app.conditionalRuleText'); ?></h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Label::class, ['fieldId' => 'category_id','fieldLabel' => __('property::app.ruleType')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                                    <select class="form-control select-picker height-35" name="rule_type"
                                        id="product_category_id" data-live-search="true">
                                        <option value="ValuatorsLimitations"<?php if($product->rule_type =='ValuatorsLimitations'): ?> selected <?php endif; ?>>Valuator's Limitations</option>
                                        <option value="InformationOfSources"<?php if($product->rule_type =='InformationOfSources'): ?> selected <?php endif; ?>>Information of Sources</option>
                                        <option value="TypeOfReport"<?php if($product->rule_type =='TypeOfReport'): ?> selected <?php endif; ?>>Type Of Report</option>
                                        <option value="RestrictionsOnDistribution"<?php if($product->rule_type =='RestrictionsOnDistribution'): ?> selected <?php endif; ?>>Restrictions On Distribution</option>
                                        <option value="ValuationReport"<?php if($product->rule_type =='ValuationReport'): ?> selected <?php endif; ?>>Valuation Report</option>
                                    </select>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Textarea::class, ['fieldLabel' => __('property::app.description'),'fieldName' => 'description','fieldId' => 'description','fieldValue' => '$product->description','fieldPlaceholder' => __('placeholders.invoices.description')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\ButtonCancel::class, ['link' => route('conditional_rule_text.index')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-product-form').click(function() {
            const url = "<?php echo e(route('conditional_rule_text.update', [$product->id])); ?>";
...
<?php /**PATH D:\xampp\htdocs\standalone\Modules\Property\Providers/../Resources/views/settings/ConditionalRuleText/ajax/edit.blade.php ENDPATH**/ ?>