...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Label::class, ['fieldId' => '','fieldLabel' => __('property::app.country')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <select class="form-control select-picker" name="country_id" id="tax_id"
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\ButtonCancel::class, ['link' => route('governorates.index')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
	...
	$(document).ready(function() {
	 ...
	 $('#save-property').click(function() {
            const url = "<?php echo e(route('governorates.store')); ?>";
...
<?php /**PATH D:\xampp\htdocs\standalone\Modules\Property\Providers/../Resources/views/settings/governorates/ajax/create.blade.php ENDPATH**/ ?>