...
<?php $component->withAttributes(['id' => 'save-product-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.edit'); ?> <?php echo app('translator')->get('property::app.governorates'); ?> </h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
...
<script>
    $(document).ready(function() {
        ...
        $('#save-product-form').click(function() {
            const url = "<?php echo e(route('governorates.update', [$product->id])); ?>";
...
<?php /**PATH D:\xampp\htdocs\standalone\Modules\Property\Providers/../Resources/views/settings/governorates/ajax/edit.blade.php ENDPATH**/ ?>