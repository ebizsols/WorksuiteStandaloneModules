...
<?php $component->withAttributes(['id' => 'save-property-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('property::app.add'); ?> <?php echo app('translator')->get('property::app.city'); ?></h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\ButtonCancel::class, ['link' => route('cities.index')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
	...
	$(document).ready(function() {
	 ...
	 $('#save-property').click(function() {
            const url = "<?php echo e(route('cities.store')); ?>";
...
<?php /**PATH D:\xampp\htdocs\standalone\Modules\Property\Providers/../Resources/views/settings/cities/ajax/create.blade.php ENDPATH**/ ?>