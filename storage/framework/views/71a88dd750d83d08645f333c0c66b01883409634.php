...
<?php $component = $__env->getContainer()->make(App\View\Components\SettingMenuItem::class, ['active' => $activeMenu,'menu' => 'payroll_settings','href' => route('payroll.payroll_settings'),'text' => __('payroll::app.menu.payrollSettings')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\standalone\Modules\Payroll\Providers/../Resources/views/sections/setting-sidebar.blade.php ENDPATH**/ ?>