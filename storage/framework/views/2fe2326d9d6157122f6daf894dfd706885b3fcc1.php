...
<?php $component->withAttributes(['id' => 'save-property-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('property::app.add'); ?> <?php echo app('translator')->get('property::app.weightageCategories'); ?></h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
...
<?php endif; ?>
	...
	$(document).ready(function() {
	 ...
	 $('#save-property').click(function() {
            const url = "<?php echo e(route('property.store')); ?>";
...
<?php /**PATH D:\xampp\htdocs\standalone\Modules\Property\Providers/../Resources/views/settings/weightageCategories/ajax/create.blade.php ENDPATH**/ ?>