...
<?php $component->withAttributes(['id' => 'save-product-form']); ?>
            ...
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.add'); ?> <?php echo app('translator')->get('property::app.propertyClasses'); ?></h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Label::class, ['fieldId' => 'statuslabel','fieldLabel' => __('property::app.type')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Text::class, ['fieldId' => 'title','fieldLabel' => __('property::app.title'),'fieldName' => 'title','fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.productName')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Textarea::class, ['fieldLabel' => __('property::app.content'),'fieldName' => 'content','fieldId' => 'description','fieldPlaceholder' => __('placeholders.invoices.description')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\ButtonCancel::class, ['link' => route('report_conditional_text.index')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-product').click(function() {
            const url = "<?php echo e(route('report_conditional_text.store')); ?>";
...
<?php /**PATH D:\xampp\htdocs\standalone\Modules\Property\Providers/../Resources/views/settings/ReportConditionalTexts/ajax/create.blade.php ENDPATH**/ ?>