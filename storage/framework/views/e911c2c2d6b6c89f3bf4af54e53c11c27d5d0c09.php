...
<?php $component->withAttributes(['id' => 'save-product-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.edit'); ?> <?php echo app('translator')->get('property::app.blocks'); ?> </h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Text::class, ['fieldId' => 'name','fieldLabel' => __('app.name'),'fieldName' => 'name','fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.productName'),'fieldValue' => $product->name] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Label::class, ['fieldId' => 'category_id','fieldLabel' => __('property::app.country')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <select class="form-control select-picker height-35" name="country_id"
                                        ...
                                        <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>" <?php if($category->id == $product->country_id): ?> selected <?php endif; ?>><?php echo e(mb_ucwords($category->name)); ?></option>
...
<?php endif; ?>
                            ...
                            <div class="col-md-4">
                                <?php if (isset($component)) { $__componentOriginal373f58fa693eb1202c1acc8658ad45d6306ee2ad = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Label::class, ['fieldId' => 'category_id','fieldLabel' => __('property::app.governorate')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <select class="form-control select-picker height-35" name="governorate_id"
                                        id="product_category_id" data-live-search="true">
                                        <option value="">--</option>
                                        <?php $__currentLoopData = $Governorate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>" <?php if($category->id == $product->country_id): ?> selected <?php endif; ?>><?php echo e(mb_ucwords($category->name)); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
                            ...
                            <div class="col-md-4">
                                <?php if (isset($component)) { $__componentOriginal373f58fa693eb1202c1acc8658ad45d6306ee2ad = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Label::class, ['fieldId' => 'category_id','fieldLabel' => __('property::app.city')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(App\View\Components\Forms\Label::class))->getConstructor()): ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <select class="form-control select-picker height-35" name="city_id"
                                        id="product_category_id" data-live-search="true">
                                        <option value="">--</option>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\ButtonCancel::class, ['link' => route('products.index')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-product-form').click(function() {
            const url = "<?php echo e(route('blocks.update', [$product->id])); ?>";
...
<?php /**PATH D:\xampp\htdocs\standalone\Modules\Property\Providers/../Resources/views/settings/blocks/ajax/edit.blade.php ENDPATH**/ ?>