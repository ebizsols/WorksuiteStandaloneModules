...
<?php $component->withAttributes(['id' => 'save-product-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.edit'); ?> <?php echo app('translator')->get('property::app.propertyClasses'); ?> </h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
...
<?php $component->withAttributes([]); ?>
                                    <select class="form-control select-picker" name="type"
                                        ...
                                        <option value="Report"<?php if($product->type =='Report 1'): ?> selected <?php endif; ?>>Report 1</option>
                                        <option value="Report"<?php if($product->type =='Report 2'): ?> selected <?php endif; ?>>Report 2</option>
                                        <option value="Report"<?php if($product->type =='Report 3'): ?> selected <?php endif; ?>>Report 3</option>
                                    </select>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-0 mr-lg-2 mr-md-2']); ?><?php echo e($product->content); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-product-form').click(function() {
            const url = "<?php echo e(route('report_conditional_text.update', [$product->id])); ?>";
...
<?php /**PATH D:\xampp\htdocs\standalone\Modules\Property\Providers/../Resources/views/settings/ReportConditionalTexts/ajax/edit.blade.php ENDPATH**/ ?>