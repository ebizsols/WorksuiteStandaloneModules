...
<?php $component->withAttributes(['id' => 'save-product-form']); ?>
            ...
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.add'); ?> <?php echo app('translator')->get('property::app.methodologyTemplate'); ?></h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Text::class, ['fieldId' => 'name','fieldLabel' => __('app.name'),'fieldName' => 'template_name','fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.productName')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                                    <select class="form-control select-picker" name="property_type_id"
...
<?php endif; ?>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Text::class, ['fieldId' => 'name','fieldLabel' => __('app.template_category'),'fieldName' => 'template_category','fieldRequired' => 'true','fieldPlaceholder' => __('placeholders.productName')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\ButtonCancel::class, ['link' => route('methodology_template.index')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-product').click(function() {
            const url = "<?php echo e(route('methodology_template.store')); ?>";
...
<?php /**PATH D:\xampp\htdocs\standalone\Modules\Property\Providers/../Resources/views/settings/methodologyTemplate/ajax/create.blade.php ENDPATH**/ ?>