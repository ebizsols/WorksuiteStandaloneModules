...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Label::class, ['fieldId' => 'statuslabel','fieldLabel' => __('property::app.ruleType')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                                    <select class="form-control select-picker" name="rule_type"
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Textarea::class, ['fieldLabel' => __('property::app.description'),'fieldName' => 'description','fieldId' => 'description'] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mr-0 mr-lg-2 mr-md-2']); ?> $product->description
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\ButtonCancel::class, ['link' => route('property_classes.index')] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-product').click(function() {
            const url = "<?php echo e(route('conditional_rule_text.store')); ?>";
...
<?php /**PATH D:\xampp\htdocs\standalone\Modules\Property\Providers/../Resources/views/settings/ConditionalRuleText/ajax/create.blade.php ENDPATH**/ ?>