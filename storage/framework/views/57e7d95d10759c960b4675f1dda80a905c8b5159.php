...
<?php $component->withAttributes(['id' => 'save-product-data-form']); ?>
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    <?php echo app('translator')->get('app.edit'); ?> <?php echo app('translator')->get('property::app.cities'); ?> </h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
...
<?php $component->withAttributes([]); ?>
                                    <select class="form-control select-picker height-35" name="country_id"
                                        ...
                                        <option value="">--</option>
                                        <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component->withAttributes([]); ?>
                                    <select class="form-control select-picker height-35" name="governorate_id"
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>" <?php if($category->id == $product->governorate_id): ?> selected <?php endif; ?>><?php echo e(mb_ucwords($category->name)); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-product-form').click(function() {
            const url = "<?php echo e(route('cities.update', [$product->id])); ?>";
...
<?php /**PATH D:\xampp\htdocs\standalone\Modules\Property\Providers/../Resources/views/settings/cities/ajax/edit.blade.php ENDPATH**/ ?>