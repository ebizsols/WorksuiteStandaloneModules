...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\LinkPrimary::class, ['link' => route('property_classifications.create'),'icon' => 'plus'] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes(['class' => 'mr-3 openRightModal float-left']); ?>
                        ...
                        <?php echo app('translator')->get('property::app.propertyClassifications'); ?>
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
         ...
         $('body').on('click', '.delete-table-row', function(){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "<?php echo e(route('property_classifications.destroy', ':id')); ?>";
                    url = url.replace(':id', id);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\standalone\Modules\Property\Providers/../Resources/views/settings/propertyClassifications/index.blade.php ENDPATH**/ ?>