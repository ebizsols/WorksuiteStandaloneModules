...
<?php $component = $__env->getContainer()->make(App\View\Components\SettingSidebar::class, ['activeMenu' => $activeSettingMenu] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('setting-sidebar'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(App\View\Components\SettingSidebar::class))->getConstructor()): ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Text::class, ['fieldLabel' => __('modules.accountSettings.companyName'),'fieldPlaceholder' => 'e.g. Acme Corporation','fieldRequired' => 'true','fieldName' => 'company_name','fieldId' => 'company_name','fieldValue' => global_setting()->company_name] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-lg-6">
                        <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Text::class, ['fieldLabel' => __('modules.accountSettings.companyEmail'),'fieldPlaceholder' => __('placeholders.email'),'fieldRequired' => 'true','fieldName' => 'company_email','fieldId' => 'company_email','fieldValue' => global_setting()->company_email] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Text::class, ['fieldLabel' => __('modules.accountSettings.companyPhone'),'fieldPlaceholder' => 'e.g. +19876543','fieldRequired' => 'true','fieldName' => 'company_phone','fieldId' => 'company_phone','fieldValue' => global_setting()->company_phone] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php endif; ?>
                    ...
                    <div class="col-lg-6">
                        <?php if (isset($component)) { $__componentOriginal3985d2df1d9ef7c51070d7c0b8f4b0e4589145ab = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Text::class, ['fieldLabel' => __('modules.accountSettings.companyWebsite'),'fieldPlaceholder' => 'e.g. https://www.spacex.com/','fieldRequired' => 'false','fieldName' => 'website','fieldId' => 'website','fieldValue' => global_setting()->website] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(App\View\Components\Forms\Text::class))->getConstructor()): ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\SettingFormActions::class, [] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('setting-form-actions'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(App\View\Components\SettingFormActions::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\ButtonCancel::class, ['link' => url()->previous()] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        $('#save-form').click(function() {
            var url = "<?php echo e(route('company-settings.update', ['1'])); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\standalone\resources\views/company-settings/index.blade.php ENDPATH**/ ?>